...
namespace Index
{
    public class PorterStemming
    {
        ...
        public bool arrayContains(string[] arr, string s)
        {
        ...
        public bool isVowel(StringBuilder s, int offset)
        {
            switch (s[offset])
            {
                case 'a':
        ...
        public bool isShortSyllable(StringBuilder s, int offset)
        {
        ...
        public bool isShortWord(StringBuilder s, int r1)
        {
        ...
        public void changeY(StringBuilder sb)
        {
            if (sb[0] == 'y') sb[0] = 'Y';
        ...
        public void computeR1R2(StringBuilder sb, ref int r1, ref int r2)
        {
            r1 = sb.Length;
            r2 = sb.Length;
        ...
        public void step0(StringBuilder sb)
        {
        ...
        public void step1a(StringBuilder sb)
        {
        ...
        public void step1b(StringBuilder sb, int r1)
        {
            for (int i = 0; i < 6; ++i)
            {
        ...
        public void step1c(StringBuilder sb)
        {
            if ((sb.Length > 0) &&
        ...
        public void step2(StringBuilder sb, int r1)
        {
            for (int i = 0; i < 24; ++i)
            {
                if (
        ...
        public void step3(StringBuilder sb, int r1, int r2)
        {
            for (int i = 0; i < 9; ++i)
            {
                if (
        ...
        public void step4(StringBuilder sb, int r2)
        {
            for (int i = 0; i < 18; ++i)
            {
                if (
        ...
        public void step5(StringBuilder sb, int r1, int r2)
        {
            if (sb.Length > 0)
                if (
                    (sb[sb.Length - 1] == 'e') &&
